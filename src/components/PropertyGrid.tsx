      ...
      <div className="px-5 pt-6 pb-6 sm:px-7.5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {properties.map((property, index) => (
            <div
              key={index}
              className="bg-white rounded-lg shadow-md overflow-hidden border border-stroke dark:border-strokedark dark:bg-boxdark"
            >
              ...
              <div className="p-4">
                ...
                {property.price && (
                  <p className="font-semibold mt-2 text-black dark:text-white">{property.price}</p>
                )}
              </div>
            </div>
          ))}
